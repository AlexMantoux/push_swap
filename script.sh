...
echo "Checker output: \c"; ./push_swap --simple $ARG5 | $checker $ARG5; echo "Valgrind: \c";
...
echo "Checker output: \c"; ./push_swap --medium $ARG5 | $checker $ARG5; echo "Valgrind: \c";
...
echo "Checker output: \c"; ./push_swap --complex $ARG5 | $checker $ARG5; echo "Valgrind: \c";
...
echo "Checker output: \c"; ./push_swap --adaptive $ARG5 | $checker $ARG5; echo "Valgrind: \c";
...
echo "Checker output: \c"; ./push_swap --adaptive $ARG10 | $checker $ARG10; echo "Valgrind: \c";
...
echo "Checker output: \c"; ./push_swap --adaptive $ARG12 | $checker $ARG12; echo "Valgrind: \c";
...
echo "Checker output: \c"; ./push_swap --adaptive $ARG13 | $checker $ARG13; echo "Valgrind: \c";
...
echo "Checker output: \c"; ./push_swap --adaptive $ARG14 | $checker $ARG14; echo "Valgrind: \c";
...
echo "Checker output: \c"; ./push_swap --adaptive $ARG15 | $checker $ARG15; echo "Valgrind: \c";
...
echo "Checker output: \c"; ./push_swap --simple $ARG16 | $checker $ARG16; echo "Valgrind: \c";
...
echo "Checker output: \c"; ./push_swap --simple $ARG17 | $checker $ARG17; echo "Valgrind: \c";
...
echo "Checker output: \c"; ./push_swap $(cat shuffle_numbers.txt) | $checker $(cat shuffle_numbers.txt); echo "Valgrind: \c";
...
echo "Checker output: \c"; ./push_swap --simple $(cat shuffle_numbers2.txt) | $checker $(cat shuffle_numbers2.txt); echo "Valgrind: \c";
...
echo "Checker output: \c"; ./push_swap --medium $(cat shuffle_numbers2.txt) | $checker $(cat shuffle_numbers2.txt); echo "Valgrind: \c";
...
echo "Checker output: \c"; ./push_swap --complex $(cat shuffle_numbers2.txt) | $checker $(cat shuffle_numbers2.txt); echo "Valgrind: \c";
...
echo "Checker output: \c"; ./push_swap --adaptive $(cat shuffle_numbers2.txt) | $checker $(cat shuffle_numbers2.txt); echo "Valgrind: \c";
...
echo "Checker output: \c"; ./push_swap --adaptive $(cat shuffle_numbers3.txt) | $checker $(cat shuffle_numbers3.txt); echo "Valgrind: \c";
